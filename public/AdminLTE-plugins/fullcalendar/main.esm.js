...
----------------------------------------------------------------------------------------------------------------------*/
// Given the scrollbar widths of some other container, post borders/margins on rowEls in order to match the left
...
function postProcess(s, date, standardDateProps, extendedSettings, context) {
    ...
    // ^ do anything that might post adjacent spaces before this point,
