    ...
    var DayGridEventRenderer = /** @class */ (function (_super) {
        ...
        DayGridEventRenderer.prototype.renderSegRow = function (row, rowSegs) {
            ...
            function emptyCellsUntil(endCol) {
                while (col < endCol) {
                    // try to grab a cell from the level above and extend its rowspan. otherwise, post a fresh cell
            ...
            for (i = 0; i < levelCnt; i++) { // iterate through all levels
                ...
                if (levelSegs) {
                    for (j = 0; j < levelSegs.length; j++) { // iterate through segments in level
                        ...
                        // post a container that occupies or more columns. append the event element.
    ...
    var DayGrid = /** @class */ (function (_super) {
        ...
        DayGrid.prototype.renderNumberCellHtml = function (date) {
            ...
            if (!isDayNumberVisible && !this.renderProps.cellWeekNumbersVisible) {
                ...
                return '<td></td>'; //  will post an empty space above events :(
            }
