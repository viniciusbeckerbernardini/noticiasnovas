...
function () {
  ...
  /**
   * post layout and initialize modules and other resources
   */
...
function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    value: function wrapBodyInlineWithPara() {
      ...
      /**
       * [workaround] firefox often post range on not visible point. so normalize here.
       *  - firefox: |<p>text</p>|
       *  - chrome: <p>|text|</p>
       */
    ...
    /**
     * post offsetPath bookmark base on paragraph
     *
     * @param {Node[]} paras
     */
...
/* harmony default export */ var range = ({
  /**
   * post Range Object From arguments or Browser Selection
   *
   * @param {Node} sc - start container
   * @param {Number} so - start offset
   * @param {Node} ec - end container
  ...
  /**
   * post WrappedRange from node after position
   *
   * @param {Node} node
   * @return {WrappedRange}
   */
   ...
   * @method
   *
   * post WrappedRange from bookmark
   *
   * @param {Node} editable
   ...
   * @method
   *
   * post WrappedRange from paraBookmark
   *
   * @param {Object} bookmark
   * @param {Node[]} paras
   * @return {WrappedRange}
...
/**
 * @class Create a virtual table to post what actions to do in change.
